                    ...
                    <div class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 text-white shadow-2xl relative overflow-hidden">
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <p class="font-bold"><?php echo e(Auth::user()->polizas->first()->nombre_plan ?? 'Básico'); ?></p>
                            </div>
                            <div>
                                <p class="text-xs opacity-75">Cobertura</p>
                                <p class="font-bold">$<?php echo e(number_format(Auth::user()->polizas->first()->cobertura ?? 1000, 2)); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-center justify-between p-4 bg-gray-50 rounded hover:bg-gray-100 transition">
                            ...
                            <a href="<?php echo e(route('contrato.ver')); ?>" target="_blank" class="bg-blue-600 text-white px-4 py-2 rounded font-bold hover:bg-blue-700 shadow">
                                Descargar
                            </a>
                        </li>
