        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-teal-600 p-6 flex justify-between items-center">
                <div>
                    ...
                    <p class="text-teal-600 font-medium">Dr. <?php echo e(Auth::user()->name); ?> | Licencia #MED-2026</p>
                </div>
            ...
            <?php if(session('success')): ?>
                <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded font-bold">✅ <?php echo e(session('success')); ?></div>
            <?php endif; ?>
            <?php if(session('error')): ?>
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded font-bold">❌ <?php echo e(session('error')); ?></div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
                    ...
                    <form action="<?php echo e(route('medico.registrar')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
