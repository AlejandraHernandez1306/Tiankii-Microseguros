...
<html>
<head>
    <title>Receta Médica - <?php echo e($atencion->paciente->name); ?></title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div class="meta">
            <p><strong>Fecha:</strong> <?php echo e($atencion->created_at->format('d/m/Y')); ?></p>
            <p><strong>Folio:</strong> #<?php echo e(str_pad($atencion->id, 6, '0', STR_PAD_LEFT)); ?></p>
        </div>
    </div>

    <div class="patient-info">
        <p><strong>Paciente:</strong> <?php echo e($atencion->paciente->name); ?></p>
        <p><strong>Médico Tratante:</strong> Dr. <?php echo e($atencion->medico->name); ?></p>
    </div>

    <div class="content">
        <div class="section-title">DIAGNÓSTICO</div>
        <p><?php echo e($atencion->diagnostico); ?></p>
    </div>

    <div class="content">
        <div class="section-title">RECETA MÉDICA (Rp)</div>
        <p style="white-space: pre-line;"><?php echo e($atencion->receta); ?></p>
    </div>
...
</html><?php /**PATH C:\Users\Ale Mar\Tiankii-Microseguros\sistema\resources\views/receta_pdf.blade.php ENDPATH**/ ?>