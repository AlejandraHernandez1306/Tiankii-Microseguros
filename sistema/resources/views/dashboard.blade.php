        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border-l-8 border-blue-700">
                <div class="p-6 text-gray-900 flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <div class="text-center sm:text-right">
                        ...
                        <p class="text-xs text-gray-400 mt-2">ID: {{ $paciente->id ?? '000-TEST' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200 relative overflow-hidden">
                    <div class="absolute top-0 right-0 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-bl-lg">ACTIVA</div>
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between border-b border-gray-100 pb-2">
                            ...
                            <span class="font-bold text-blue-900 text-right">{{ $poliza['plan'] }}</span>
                        </div>
                        <div class="flex justify-between border-b border-gray-100 pb-2">
                            <span class="text-gray-500 text-sm">Cobertura Disp.:</span>
                            <span class="font-bold text-green-600 text-xl">{{ $poliza['cobertura'] }}</span>
                        </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button onclick="alert('Módulo de Citas: Conectando con agenda de médicos rurales...')" class="flex flex-col items-center justify-center p-4 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition border border-blue-200">
                        ...
                        <button onclick="alert('Pasarela de Pagos (Stripe Sandbox): No hay cuotas pendientes.')" class="flex flex-col items-center justify-center p-4 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 transition border border-indigo-200">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center text-sm text-gray-700 p-2 bg-gray-50 rounded">
                        ...
                        <li class="flex items-center text-sm text-gray-400 p-2 border border-dashed rounded">
