            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button onclick="alert('Módulo de Citas...')" class="flex flex-col items-center justify-center p-4 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition border border-blue-200">
                        ...
                        <button onclick="alert('Stripe Sandbox...')" class="flex flex-col items-center justify-center p-4 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 transition border border-indigo-200">
                    ...
                    <button onclick="alert('SOS ACTIVADO')" class="w-full mt-3 bg-red-50 text-red-600 font-bold py-2 rounded-lg border border-red-200 hover:bg-red-100 flex justify-center items-center gap-2">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md border border-slate-200">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-center text-sm text-gray-400">❌ Cirugía Estética</li>
                    </ul>
                </div>
            </div>
